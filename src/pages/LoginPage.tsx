...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12 bg-surface-50">
        <div className="w-full max-w-md">
          ...
          <div className="card p-8">
            ...
            {error && (
              <div className="mb-6 rounded-lg bg-red-50 border border-red-200 p-4 text-sm text-red-700 animate-slide-up">
                {error}
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {isSignUp && (
                <div>
                  <label className="block text-sm font-medium text-surface-700 mb-1.5">氏名</label>
                  <input
                    type="text"
                    value={fullName}
              ...
              <div>
                <label className="block text-sm font-medium text-surface-700 mb-1.5">メールアドレス</label>
